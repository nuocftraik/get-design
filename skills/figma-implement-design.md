...
source: https://github.com/figma/mcp-server-guide/tree/main/skills/figma-implement-design
author: Figma
---
...
6. If yes → extend with new variant; if no → create new component using project conventions
...
2. Run `get_metadata(fileKey="pR8mNv5KqXzGwY2JtCfL4D", nodeId="10-5")` to understand page structure
